...
{
  GFile *ff = g_file_new_for_uri ("resource:///github/xverizex/nem-desktop/in_message.mp3");
  ...
  snprintf (ppath, 512,"filesrc location=%s/in_message.mp3 "
	...
	self->image_header_left_pane = g_object_new (GTK_TYPE_IMAGE,
                                               "resource", "/github/xverizex/nem-desktop/left-pane.svg",
                                               NULL);
  ...
  self->image_handshake = g_object_new (GTK_TYPE_IMAGE,
                                        "resource", "/github/xverizex/nem-desktop/handshake.svg",
